...
public class GameApp extends Base2DGame {
    ...
    public void init(GameContext context) {
        ...
        exitButton = new ButtonGUI(context, 10, 100, "退出游戏", new Font(Font.MONOSPACED, Font.PLAIN, 12), 10);
    ...
    public static void main(String[] args) {
        JFrame frame = new JFrame("Zest2D Engine Example");
